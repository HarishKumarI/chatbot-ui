...
function Card(props){
    ...
    return  <div className="card" 
                ...
                onClick={e => { if( card_data.url !== undefined ) window.open( card_data.image, '_blank' ) } }
                >
...
class ChatBot extends React.Component{
    ...
    async componentDidMount(){
        ...
        // this.setState({
        //     msgs: uiJSON.msgs.map( msg => { return this.getMsgs( msg )[0] } )
        // })
            ...
            if( index === 0 || ( index > 0 && msgs[index-1].user_type !== 'bot'  ) )
                ...
                msgs_list.push( 
                    <div className="chat-persona" key={index+'_0'}>
                        <img src={ uiJSON.bot_image } alt="bot_image" className="bot_image" />  
                        <div className="bot_name">{ uiJSON.bot_name }</div>
                    </div>
                )   
                ...
                msgs_list.push(
                    <div className="card-carousel" key={index+'_3'}>
                        ...
                        <div className="card-carousel-container">
                            { msg_data.answerJson[0].content.map( ( card_info, idx ) => {
